...
<div class="container-fluid service overflow-hidden py-5">
    <div class="container py-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
...
" class="img-fluid w-100 rounded" alt="Image">
                        ...
                        <div class="service-title">
                            <div class="service-title-name">
                                ...
                                <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4" href="/visas">Explore More</a>
                            </div>
                            <div class="service-content pb-4">
                                <a href="#"><h4 class="text-white mb-4 py-3">{{$item->name}}</h4></a>
                                <div class="px-4">
                                    <a class="btn btn-primary border-secondary rounded-pill py-3 px-5" href="/visas">Explore More</a>
                                </div>
                            </div>
                        </div>
                    </div>
